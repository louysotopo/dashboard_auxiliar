...
public class ListZoomSegmentation extends View {
    ...
    public void loadImage(Bitmap nImage){
        //mImage = img;
        float aspectRatio = (float) nImage.getHeight()/nImage.getWidth();
        DisplayMetrics displayMetrics = getResources().getDisplayMetrics();
        mImageWidth = displayMetrics.widthPixels;
        mImageHeight = Math.round(mImageWidth*aspectRatio);
        this.mImage =  Bitmap.createScaledBitmap(nImage,mImageWidth,mImageHeight,false);
        invalidate();
        //requestLayout();
    }
    /**
